...
int main(int argc, char *argv[])
{
	...
	Coat c5{ "PNK36", 36, "Pink", 159.14, 0, "http://lp2.hm.com/hmprod?set=source[/environment/2016/8EZ_0149_013R.jpg],width[4000],height[4677],x[643],y[118],type[FASHION_FRONT]&hmver=0&call=url[file:/product/main]" };
